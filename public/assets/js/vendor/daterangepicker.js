                ...
                '<div class="calendar left">' +
                    '<div class="daterangepicker_input">' +
                      ...
                      '<div class="calendar-time">' +
                        '<div></div>' +
                        '<i class="fa fa-clock-o fa fa--time"></i>' +
                      '</div>' +
                    '</div>' +
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if (this.showDropdowns) {
                ...
                var monthHtml = '<select class="monthselect selectbox custom-select">';
                for (var m = 0; m < 12; m++) {
                ...
                var yearHtml = '<select class="yearselect selectbox custom-select">';
